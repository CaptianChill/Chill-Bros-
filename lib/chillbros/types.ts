...
export type Job = {
  ...
  parts: { id: string; name: string; partNumber: string; retailPrice: number; quantity: number }[];
  beforePhotos: { id: string; storagePath: string; caption: string | null; url: string | null }[];
  afterPhotos: { id: string; storagePath: string; caption: string | null; url: string | null }[];
};
