...
const MODELS: Record<string, BoxPart[]> = {
  rtu: [
    ...
    { name: "COMP_Y_INPUT", translation: [-1.96, -0.82, 0.86], scale: [0.2, 0.12, 0.18], material: 4 },
    { name: "COMP_RUN_CAPACITOR", translation: [0.35, -0.8, 0.75], scale: [0.28, 0.18, 0.52], material: 5 },
    ...
    { name: "COMP_FILTER_DRIER", translation: [0.48, -0.72, -0.28], scale: [0.16, 0.16, 0.62], material: 3 },
    { name: "COMP_CONDENSER_FAN_MOTOR", translation: [1.35, 0.82, 0.75], scale: [0.62, 0.32, 0.42], material: 5 },
    { name: "COMP_BLOWER_MOTOR", translation: [-1.55, 0.08, -0.82], scale: [0.72, 0.52, 0.54], material: 1 },
    { name: "COMP_CONDENSATE_DRAIN", translation: [-2.05, -0.45, -1.02], scale: [0.42, 0.32, 0.22], material: 4 },
  ],
  "reach-in": [
