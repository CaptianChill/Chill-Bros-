  ...
  return (
    ...
    >
      <div className="mb-4 grid gap-4 md:grid-cols-2">
        <SectionCard eyebrow="How to use it" title="Search the symptom before starting from zero" description="Enter the fault, reading, error code, or component. Similar Bible cases surface first so technicians can compare the current job to a proven diagnostic path.">
        ...
        <SectionCard eyebrow="3D roadmap" title="Every case maps to equipment components" description="The component list below each case already follows the Blender naming approach. Real GLB equipment models can replace the current training blocks without rewriting the Bible content.">
