...
export default async function SchedulePage({ searchParams }: Props) {
  ...
  const [rawCustomers,technicians,jobs] = await Promise.all([getCustomers(),getActiveTechnicians(),getDispatchJobs(500)]);
