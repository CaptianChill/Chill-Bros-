...
export default async function TechnicianPage({ searchParams }: Props) {
  ...
  const [invoice, feeSettings, partsCatalog] = job ? await Promise.all([getInvoiceByJobId(job.id), getFeeSettings(), getPartsCatalog()]) : [null, [], []];
