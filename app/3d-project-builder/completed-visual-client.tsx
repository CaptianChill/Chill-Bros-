...
import { ArrowLeft, Play, RefreshCcw, WandSparkles } from "lucide-react";
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[.8fr_1.2fr]">
        <section className="rounded-3xl border border-[#2d7dff]/25 bg-black/45 p-4">
          ...
          <button onClick={prepareRender} className="mt-4 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl border border-[#8ffafa]/55 bg-[#2d7dff]/18 font-semibold text-white"><WandSparkles className="h-4 w-4"/>Prepare AI finished version</button>
