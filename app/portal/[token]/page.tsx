    ...
    <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
      <SectionCard eyebrow="Customer view" title="Itemized estimate and work summary" description="Line-item pricing with quantity, description, discounts, deposit terms, and proof-of-work media.">
        <div className="space-y-4">
          ...
          <Link href={`/portal/${invoice.portalToken}/document`} className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-[#2d7dff]/30 px-4 py-3 text-sm text-[#d9fbff]"><FileText className="h-4 w-4" />Open fullscreen document view</Link>
