  ...
  >
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <SectionCard eyebrow={invoiceIssued ? "Payment" : "Approval"} title={invoiceIssued ? "Pay securely" : invoice.status === "approved" ? "Approved · next step is the work" : "Review and approve"} description={invoiceIssued ? "Pay through Square using the invoice total shown here." : "Approval authorizes the work. Final payment does not open until Chill Pros completes the job and issues the invoice."}>
