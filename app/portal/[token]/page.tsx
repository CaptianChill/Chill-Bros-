...
export default async function PortalPage({ params }: PortalPageProps) {
  ...
  return <PortalShell
    ...
    description="Review itemized pricing, tax, discounts, terms, service details, proof-of-work, digital approval, and payment preference."
  ...
  >
    <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
      ...
      <SectionCard eyebrow="Approval & payment preference" title="Review, sign, and choose a payment method" description="Taxes, discounts, required down payment, credits, and due terms shown here are part of the customer document.">
