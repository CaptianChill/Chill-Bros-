  ...
  return <main className="min-h-screen bg-white px-3 py-4 text-zinc-950 sm:px-6 sm:py-8 print:p-0">
    <div className="mx-auto max-w-3xl">
      ...
      <article className="overflow-hidden rounded-2xl border border-zinc-300 bg-white shadow-xl print:rounded-none print:border-0 print:shadow-none">
        <header className="bg-[#0A1A33] px-6 py-6 text-white"><div className="flex items-center justify-between gap-4"><div className="flex items-center gap-3"><LogoBadge variant="full" className="w-14" /><div><p className="text-2xl font-bold">CHILL PROS</p><p className="text-xs uppercase tracking-[0.24em] text-cyan-100">Payment Receipt</p></div></div><div className="text-right"><p className="text-xs text-cyan-100">RECEIPT</p><p className="mt-1 text-lg font-bold">{receipt.receipt_number}</p></div></div></header>
