        ...
        <div className="rounded-2xl border border-[#00f0f0]/20 bg-zinc-950/80 p-4">
          ...
          <div className="space-y-3">
            {beforePhotos.map((photo) => (
              <div key={photo} className="flex items-center justify-between rounded-2xl border border-[#00f0f0]/20 bg-black/60 px-3 py-2 text-sm text-zinc-200">
                <span>{photo}</span>
                <CheckCircle2 className="h-4 w-4 text-emerald-300" />
              </div>
            ))}
          </div>
          <button type="button" className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-[#00f0f0]/40 px-4 py-3 text-sm text-[#defefe] transition hover:bg-[#00f0f0]/10">
